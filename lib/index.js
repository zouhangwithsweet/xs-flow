...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "xstream"], factory);
    }
     ...
     * 用来描述一个路由模块
     */
    var StreamRouteBlock = /** @class */ (function () {
        function StreamRouteBlock() {
        }
        StreamRouteBlock.type = 'r';
        return StreamRouteBlock;
    }());
    /**
     * 用来描述一个决策模块
     */
    var StreamDecisionBlock = /** @class */ (function () {
        function StreamDecisionBlock(router, store) {
        }
        StreamDecisionBlock.type = 'd';
        return StreamDecisionBlock;
    }());
    /**
     * flow 类
     * 用来描述一个用户的流程
    ...
    var StreamFlow = /** @class */ (function () {
        ...
        StreamFlow.prototype.create = function () {
            this._stream = xstream_1.default.create(this._producer);
